...
* <li>integerAction() returns an Integer.java for the String value, which must be a decimal integer</li>
...
* <li>integerRangeAction( int min, int max ) returns an Integer.java for the String value, which must be a
...
* <li>convertIntegerToShort coerces an Integer.java into a Short.</li>
* </ul>
